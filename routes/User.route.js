...
UserRouter.get("/api/v1/users/profile",isAuthenticated,userController.UserProfile)
UserRouter.put("/api/v1/users/change-password",isAuthenticated,userController.ChangePass);
